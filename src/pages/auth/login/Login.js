        ...
        return (
            <div className="auth-page">
                    ...
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Login to your Web App</h3>}>
                        <form onSubmit={this.doLogin}>
                            ...
                            <FormGroup className="mt">
                                <Label for="email">Email Address/ Username/ Employee Number</Label>
                ...
                <footer className="auth-footer">
                    {new Date().getFullYear()} &copy; Cylabs Hunter <a href="https://www.cylabs.co.uk/" rel="noopener noreferrer" target="_blank">Cylabs UK</a>
                </footer>
            </div>
        );
    }
